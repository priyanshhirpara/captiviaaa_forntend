...
const CommentModal = ({ post, commentText, onCommentChange, onCommentSubmit, onClose, currentUser }: { post: any, commentText: string, onCommentChange: (e: React.ChangeEvent<HTMLInputElement>) => void, onCommentSubmit: () => void, onClose: () => void, currentUser: any }) => {
    ...
    const handleCommentSubmit = () => {
        if (commentText.trim()) {
            const newComment = {
                ...
                user_profile_picture: currentUser.personal_information?.profile_picture || "https://via.placeholder.com/40",
            ...
            <div className="relative bg-white dark:bg-[#262626] w-full max-w-4xl h-[90vh] flex overflow-hidden rounded-xl">
                ...
                <div className="w-1/2 flex flex-col">
                    ...
                    <div className="flex items-center p-4 border-b border-gray-200 dark:border-gray-800">
                        <img 
                            src={post.user_profile_picture || "https://via.placeholder.com/40"} 
                            alt={post.username} 
                        ...
                        {comments.length > 0 ? (
                            comments.map((comment: any) => (
                                <div key={comment.id} className="flex items-start mb-4">
                                    <img
                                        src={comment.user_profile_picture || "https://via.placeholder.com/30"}
                    ...
                    <div className="border-t border-gray-200 dark:border-gray-800 p-3 flex items-center">
                        ...
                        <button
                            ...
                            className={`font-semibold ${commentText.trim() ? 'text-blue-500' : 'text-blue-300'}`}
                        >
                            Post
                        </button>
                    </div>
